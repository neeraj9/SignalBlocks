...
The following figure is the websocket demo after opening the <a href="examples/websocket_demo/htmlapp/websocket.html"></a> in browser and running websocket_demo with a sample audio file. Notice that the surrounding oscilloscope, which thanks to [Soundbeam iPhone Project](http://www.evilwindowdog.com/soundbeam/) looks cool. The surrounded signal is streaming from the websocket demo app.
