...
TEST_CASE("Testing block arcsinh for scalar integer", "[arcsinh]") {
    ...
    double expected_result = gsl_asinh(input_value);
...
TEST_CASE("Testing math block arcsinh for vector integer", "[arcsinh]") {
    // no ctor args required
    double input_value = M_PI;
    int len = 10;
...
TEST_CASE("Testing math block arcsinh for matrix integer", "[arcsinh]") {
    // no ctor args required
    double input_value = M_PI;
