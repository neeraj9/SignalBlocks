...
template
class BinaryOperator<long>;

template
class BinaryOperator<unsigned long>;

template
class BinaryOperator<int>;

template
class BinaryOperator<unsigned int>;

template
class BinaryOperator<short>;

template
class BinaryOperator<unsigned short>;

template
class BinaryOperator<char>;

template
class BinaryOperator<unsigned char>;

template
class BinaryOperator<float>;

template
class BinaryOperator<double>;
