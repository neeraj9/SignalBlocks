//
// $Id: interpolation-test.cc,v 1.5 2006-05-01 14:24:57 cholm Exp $ 
//  
//  interpolation/interpolation-test.cc
...
/** @file   interpolation-test.cc
    @author Christian Holm
    @date   Mon Sep 16 13:03:50 2002
    @brief  Test of interpolation classses.  */

//____________________________________________________________________  
int main(int argc, char** argv) 
{
  gslmm::test_suite ts("interpolation", argc, argv);
