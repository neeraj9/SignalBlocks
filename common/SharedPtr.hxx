...
template<class T, class Y> void sp_enable_shared_from_this( shared_count const & pn, BoostPort::enable_shared_from_this<T> const * pe, Y const * px )
{
